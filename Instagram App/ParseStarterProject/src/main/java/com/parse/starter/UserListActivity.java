...
public class UserListActivity extends AppCompatActivity {
    ...
    public void getPhoto(){
        ...
        startActivityForResult(intent, 1); //When it is finished, method onActivityResult is fired
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (item.getItemId() == R.id.uploads){
            Intent intent = new Intent(getApplicationContext(), MyFeedActivity.class);
            startActivity(intent);
        }
        else if (item.getItemId() == R.id.connections){
